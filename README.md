...
<p align="center">
  <a href="assets/yunxu-chat-popup-r063.png">
    <img src="assets/yunxu-chat-popup-r063.png" alt="云序对话浏览器扩展界面，显示导出 Markdown、PDF、复制全文和批量导出历史入口" width="420">
  </a>
</p>

<p align="center"><sub>云序对话 V0.1.12 · 修订 063 实际扩展界面。截图当前为简体中文；扩展同时内置 English 界面。</sub></p>
